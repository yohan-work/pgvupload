    ...
    try:
        ...
        def generate_rag_response():
            try:
                ...
                # 3) 프롬프트 구성 (한국어 강제)
                prompt = f"""[SYSTEM] 당신은 반드시 한국어로만 답변해야 하는 AI 어시스턴트입니다. 

**중요 지침:**
- 모든 답변은 반드시 한국어로만 작성해야 합니다
- 영어나 다른 언어로는 절대 답변하지 마세요
- 기술 용어나 고유명사도 가능한 한국어로 설명하세요
- 코드나 명령어 등은 예외이지만 설명은 반드시 한국어로 해주세요

아래 문서들을 참고하여 질문에 정확하고 친절하게 한국어로만 답변해주세요.
